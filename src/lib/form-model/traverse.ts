import type { Answer, AnswerSet, Condition, Field, Form } from "./types";

/**
 * Ported from main's packages/form-model/src/traverse.ts, unmodified logic.
 * The conversation engine depends on these — see conversation/machine.ts.
 */
