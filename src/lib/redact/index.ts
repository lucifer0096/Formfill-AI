import { detect, type PiiKind, type PiiSpan } from "./detectors";

export * from "./detectors";

/**
 * Redaction: the gate between the device and the network. Ported from main's
 * packages/redact/src/index.ts, unmodified logic — see docs/PRIVACY.md on
 * main §3.
 *
 ...
 *
 * The rehydration map lives in memory for the lifetime of one request. It is
