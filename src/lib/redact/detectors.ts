/**
 * PII detectors. Ported from main's packages/redact/src/detectors.ts — see
 * docs/PRIVACY.md on main §3 for the full rationale. Not imported directly
 * (this branch isn't wired into the npm workspace yet, same reason
 * src/lib/form-model/types.ts is hand-duplicated), but unmodified logic.
 *
