...
/**
 * Local, synchronous field validation. Runs entirely on-device — validating an
 * answer must never require a network call, because answers never leave the
 * device (docs/PRIVACY.md §1).
 *
